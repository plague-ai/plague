    ...
    <div className='relative flex flex-col h-screen text-white'>
      ...
      </div>
      {
        ...
        <div className={styles.infoContainer}>
          ...
          <progress class="progress progress-error w-56 mb-2" value={
            (Number(informedRef.replace(/,/g, "")) / 100000) * 100
            } max="100"></progress>
        </div>
      </div>
      }
      ...
      <div className='fixed top-1/4 bg-black bg-opacity-50 right-2 p-4 rounded flex flex-col gap-10'>
        <Link href="https://x.com/plague_ai"><Image src='/X Logo-01.png' alt='twitter' width={40} height={40}/></Link>
